...
const AddVendorNational = ({ onClose, onSubmit }) => {
  ...
  const handleRequestOtp = () => {
    // Here you would typically make an API call to send OTP to accountant
    // For now, we'll just simulate it
    toast.success('OTP sent to accountant');
  ...
  const handleSubmit = (e) => {
    ...
    // Validate OTP here (in a real app, you would verify with backend)
    if (!formData.otp) {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      ...
      <div className="bg-white rounded-lg shadow-xl w-full max-w-4xl max-h-[90vh] overflow-y-auto">
        <div className="sticky top-0 bg-white p-4 border-b flex justify-between items-center">
          <h2 className="text-xl font-bold text-gray-800">National Vendor Registration</h2>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <div className="mt-6 space-y-4">
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
                  {['Private Ltd.', 'Public Ltd.', 'Partnership', 'LLP', 'Government', 'Sole Proprietorship'].map((option) => (
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-1">
                <label className="block text-sm font-medium text-gray-700">Account Currency</label>
                <input
                  type="text"
          ...
          {formData.showOtpField && (
            <div className="bg-blue-50 p-4 rounded-md">
              <h3 className="text-lg font-semibold mb-2 text-gray-800">OTP Verification</h3>
              <div className="flex items-center gap-4">
                <input
                  type="text"
                  name="otp"
...
export default AddVendorNational;